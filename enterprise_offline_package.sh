...
${IMAGE_DOMAIN}/${DOCKER_NAMESPACE}/rainbond:$RBD_VER-allinone
${IMAGE_DOMAIN}/${DOCKER_NAMESPACE}/rbd-node:$RBD_VER
${IMAGE_DOMAIN}/${DOCKER_NAMESPACE}/rbd-resource-proxy:$RBD_VER
${IMAGE_DOMAIN}/${DOCKER_NAMESPACE}/rbd-eventlog:$RBD_VER
${IMAGE_DOMAIN}/${DOCKER_NAMESPACE}/rbd-worker:$RBD_VER
${IMAGE_DOMAIN}/${DOCKER_NAMESPACE}/rbd-gateway:$RBD_VER
${IMAGE_DOMAIN}/${DOCKER_NAMESPACE}/rbd-chaos:$RBD_VER
${IMAGE_DOMAIN}/${DOCKER_NAMESPACE}/rbd-api:$RBD_VER
${IMAGE_DOMAIN}/${DOCKER_NAMESPACE}/rbd-webcli:$RBD_VER
${IMAGE_DOMAIN}/${DOCKER_NAMESPACE}/rbd-mq:$RBD_VER
${IMAGE_DOMAIN}/${DOCKER_NAMESPACE}/rbd-monitor:$RBD_VER
${IMAGE_DOMAIN}/${DOCKER_NAMESPACE}/rbd-mesh-data-panel:$RBD_VER
${IMAGE_DOMAIN}/${DOCKER_NAMESPACE}/rbd-init-probe:$RBD_VER
${IMAGE_DOMAIN}/${DOCKER_NAMESPACE}/rbd-grctl:$RBD_VER
${IMAGE_DOMAIN}/${DOCKER_NAMESPACE}/rainbond-operator:$RBD_VER
...
function main() {
    ...
    git clone $BRANCH --depth=1 https://$GITLAB_USER:$GITLAB_PASS@git.goodrain.com/goodrain/rainbond-chart.git
